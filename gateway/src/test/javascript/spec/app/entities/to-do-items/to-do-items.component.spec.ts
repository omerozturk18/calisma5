...
import { ToDoItemsComponent } from 'app/entities/to-do-items/to-do-items.component';
...
describe('Component Tests', () => {
  describe('ToDoItems Management Component', () => {
    let comp: ToDoItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ToDoItemsComponent, '')
        .compileComponents();
